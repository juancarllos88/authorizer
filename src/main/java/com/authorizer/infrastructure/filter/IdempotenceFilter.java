...
public class IdempotenceFilter extends OncePerRequestFilter {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class IdempotencyValue implements Serializable {
...
//        public <K, V> IdempotencyValue(Map<String, Object> kvMap, int i, String s, boolean b) {
//        }
